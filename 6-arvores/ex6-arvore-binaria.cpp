...
void BinaryTree::remove(Data value) {
    ...
    if (element->left == NULL and element->right == NULL) {
        ...
        if (element->left == NULL ^ element->right == NULL) {
            ...
            this->move(element, element->right == NULL ? element->left : element->right);
        } else {
            ...
            // não tem porque dizer que o filho a direita do sucessor seja filho do nó que
            // será removido
...
int main() {
    ...
    // cout << (binary.search(value) ? "Elemento existe!" : "Elemento não existe!") <<
    // endl;
    ...
    binary.preOrder();
    cout << "Imprimindo pos ordem: " << endl;
    binary.posOrder();
    return 0;
}
